            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            <?php
                                $get_vendor = "SELECT * FROM vendor where vendor_email = '$vendor_email'";
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="index.php?user_delete=<?php echo $vendor_id; ?>">
                                        <i class="fa fa-trash-o"></i> Delete
                                    </a>
                                </td>
                                <td>
                                <a href="index.php?edit_user=<?php echo $vendor_id; ?>">
