...
if(!isset($_SESSION['vendor_email'])){
    ...
    if(isset($_SESSION['vendor_email'])){
        $vendor_email_session =$_SESSION['vendor_email'];
        $query="SELECT * FROM vendor WHERE vendor_email ='$vendor_email_session'";
...
<?php
    ...
    //you need to make vendor use his/her own id right you can put any id there...
       ...
       // $vendor_id = $_POST['vendor_id'];
        ...
        copy("product_images/$product_img1","../admin_area/product_images/$product_img1");
