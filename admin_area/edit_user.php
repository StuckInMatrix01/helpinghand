...
<?php
    ...
    admin_image='$admin_image',admin_contact='$admin_contact',admin_city='$admin_city',admin_job='$admin_job',admin_about='$admin_about' WHERE admin_id='$admin_id'";

    $run_admin = mysqli_query($con,$update_admin) or die(mysqli_error($con));
        if($run_admin){
