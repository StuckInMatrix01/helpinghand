...
<?php
    if(isset($_POST['submit'])){
        ...
        $insert_admin = "INSERT INTO admins (admin_name,admin_email,admin_pass,admin_image,admin_contact,admin_city,admin_job,admin_about) 
        VALUES ('$admin_name','$admin_email','$admin_pass','$admin_image','$admin_contact','$admin_city','$admin_job','$admin_about')";

        $run_admin = mysqli_query($con,$insert_admin) or die(mysqli_error($con));
            if($run_admin){
